# AI Agent Guide — Import / Export Customizer Settings

## Quick Start for AI Agents

1. **Entry point:** Start at `astra-import-export.php` to understand plugin initialization
...
4. **Text domain:** Use `astra-import-export` for all translatable strings
...
1. Wrap strings in `__( 'text', 'astra-import-export' )` or `esc_html__( 'text', 'astra-import-export' )`
...
- [ ] Text domain `astra-import-export` used for all user-facing strings
