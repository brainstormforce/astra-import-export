# Architecture — Import / Export Customizer Settings

## Overview

Import / Export Customizer Settings is a WordPress plugin that follows standard WordPress plugin architecture patterns.

## Entry Point

The plugin entry point is `astra-import-export.php`, which:
...
1. WordPress loads the plugin via `astra-import-export.php`
